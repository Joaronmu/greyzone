...
FBX = "C:/Users/零零/Downloads/boss.fbx"
...
# adaptive params -- tune to ~40-50k clusters (same decimation level as y-target / mini-boss)
R_FINE=0.012
CELL_FINE=0.0056
CELL_COARSE=0.0167
...
open("zmodel.bin","wb").write(blob)
b64=base64.b64encode(blob).decode('ascii')
open("zmodel.b64","w").write(b64)
print("blob %d (%.1f KB)  b64 %d (%.1f KB)"%(len(blob),len(blob)/1024,len(b64),len(b64)/1024))
print("DONE C=%d ntri=%d"%(C,ntri))
